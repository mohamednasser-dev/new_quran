                ...
                <div class="card-body">
                    <div class="d-flex align-items-center p-5">
                        ...
                        <div class="d-flex flex-column">
                            <a href="{{route('dorr.index')}}" class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">
                                {{trans('s_admin.dorr_epos')}}
                            </a>
            ...
            <div class="card card-custom wave wave-animate wave-danger mb-8 mb-lg-0">
                <div class="card-body">
                    <div class="d-flex align-items-center p-5">
                        ...
                        <div class="d-flex flex-column">
                            <a href="{{route('colleges.index')}}" class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">
