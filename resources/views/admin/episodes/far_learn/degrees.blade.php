...
@section('title')
    <div class="d-flex align-items-center flex-wrap mr-2">
        <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">{{trans('s_admin.nav_home_far_ErrorType')}}</h5>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-light-danger font-weight-bold mr-2"
                               href="{{route('far_episode_ErrorType.delete',$row->id)}}">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ Form::open( ['route' =>'far_episode_ErrorType.store','method'=>'post', 'files'=>'true'] ) }}
                    {{ csrf_field() }}
                    <div class="card-body">
    ...
    <div class="modal fade" id="edit_model" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ Form::open( ['route' =>'far_episode_ErrorType.update','method'=>'post', 'files'=>'true'] ) }}
                    {{ csrf_field() }}
