...
@section('title')
    <div class="d-flex align-items-center flex-wrap mr-2">
        <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">{{trans('s_admin.nav_home_country')}}</h5>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-light-danger font-weight-bold mr-2"
                               href="{{route('country.delete',$row->id)}}">
    ...
    <div class="modal fade" id="edit_model" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ Form::open( ['route' =>'country.update','method'=>'post', 'files'=>'true'] ) }}
                    {{ csrf_field() }}
