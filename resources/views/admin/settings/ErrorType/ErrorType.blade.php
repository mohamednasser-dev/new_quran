                ...
                <div class="modal-body">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="number" required class="form-control" id="txt_name_en"  name="hasm_degree">
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <select required name="start_hasm" class="form-control form-control-lg" id="exampleSelectl">
                                    <option value="1">{{trans('admin.fawry')}}</option>
                                    <option value="2">{{trans('admin.second_time')}}</option>
                                    <option value="3">{{trans('admin.third_time')}}</option>
                                    <option value="4">{{trans('admin.fourth_time')}}</option>
                                    <option value="5">{{trans('admin.fifth_time')}}</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
