        ...
        <form class="form">
            <div class="card-body">
                <div class="form-group row mt-3">
                    ...
                    <label class="col-lg-1 col-form-label text-lg-right">{{trans('s_admin.phone')}}</label>
                    <div class="col-lg-3">
                        <input type="email" class="form-control">
                    </div>
                    <label class="col-lg-1 col-form-label text-lg-right">{{trans('s_admin.ident_num')}}</label>
                    <div class="col-lg-3">
                        <input type="text" class="form-control" >
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-1 col-form-label text-lg-right">{{trans('s_admin.nationality')}}</label>
                    <div class="col-lg-3">
                    ...
                    <label class="col-lg-1 col-form-label text-lg-right">{{trans('s_admin.study_section')}}</label>
                    <div class="col-lg-3">
                    ...
                    <label class="col-lg-1 col-form-label text-lg-right">{{trans('s_admin.subject')}}</label>
                    <div class="col-lg-3">
                        <div class="input-group">
                            <input type="text" class="form-control" >
                            <div class="input-group-append">
                ...
                <div class="form-group row">
                    <label class="col-lg-1 col-form-label text-lg-right">{{trans('s_admin.student_status')}}</label>
                    <div class="col-lg-3">
                    ...
                    <label class="col-lg-1 col-form-label text-lg-right">{{trans('s_admin.attendance_type')}}</label>
                    <div class="col-lg-3">
                        <div class="radio-inline">
                            <label class="radio radio-solid">
                                <input type="radio" name="example_2" checked="checked" value="2">
            ...
            <div class="card-footer">
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <button type="reset" class="btn btn-primary mr-2">{{trans('s_admin.search')}}</button>
                    </div>
                </div>
            </div>
        </form>
