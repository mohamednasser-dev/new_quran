...
@section('content')
    <div class="container">
        <div class="d-flex flex-row">
                    ...
                    <div class="card-body pt-4">
                        <div class="d-flex align-items-center">
                            <div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
                                ...
                                @else
                                    <div class="symbol-label" style="background-image:url('{{$data->image}}')"></div>
                                @endif
                            ...
                            <div>
                                ...
                                <div class="text-muted">@if($data->gender == 'male') {{trans('admin.teacher')}} @elseif($data->gender == 'female') {{trans('admin.teacher_female')}} @endif </div>
                                <div class="mt-2">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                            <div class="navi-item mb-2">
                                <a href="{{route('teacher.profile')}}" class="navi-link py-4 @if(Route::current()->getName() == 'teacher.profile' ) active @endif">
                            ...
                            <div class="navi-item mb-2">
                                <a href="{{route('teacher.change_pass')}}" class="navi-link py-4  @if(Route::current()->getName() == 'teacher.change_pass' ) active @endif ">
                                    <span class="navi-icon mr-2">
                                        <span class="svg-icon">
            ...
            @if(Route::current()->getName() == 'teacher.profile')
                @include('teacher.profile.personal_info')
            @else
                @include('teacher.profile.change_pass')
            @endif
        </div>
