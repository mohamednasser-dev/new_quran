...
function websdkready() {
  ...
  var API_KEY = "6-ildQiCRHOJDq2mv-y5pA";
   ...
   */
  var API_SECRET = "KjNuS6o9mS7GV5VLwEbSCG1pxm1SpyUZg9KW";
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "http://127.0.0.1:8000/teacher/t_episodes/zoom/meeting/?" + testTool.serialize(meetingConfig);
